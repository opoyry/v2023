...
class GluePipelineStack(cdk.Stack):
    def __init__(self, scope: Construct, construct_id: str, **kwargs):
        ...
        raw_bucket.add_event_notification(
            _s3.EventType.OBJECT_CREATED, s3n.SqsDestination(glue_queue)
        )
        ...
        glue_role = _iam.Role(
            ...
            inline_policies={
                "glue_policy": _iam.PolicyDocument(
                    statements=[
        ...
        glue_database = _glue.CfnDatabase(
            ...
            database_input=_glue.CfnDatabase.DatabaseInputProperty(
                name="price-database", description="Database to store prices."
            ),
        )
        _lakeformation.CfnPermissions(
            self,
            ...
            resource=_lakeformation.CfnPermissions.ResourceProperty(
                database_resource=_lakeformation.CfnPermissions.DatabaseResourceProperty(
                    catalog_id=glue_database.catalog_id, name="price-database"
                )
            ),
            permissions=["ALL"],
        )
            ...
            _glue.CfnTrigger(
                ...
                actions=[
                    _glue.CfnTrigger.ActionProperty(
                        ...
                        notification_property=_glue.CfnTrigger.NotificationPropertyProperty(
                ...
                predicate=_glue.CfnTrigger.PredicateProperty(
                    conditions=[
                        _glue.CfnTrigger.ConditionProperty(
        ...
        _events.CfnRule(
            ...
            event_pattern={
                ...
                "detail": {"bucket": {"name": [f"{raw_bucket.bucket_name}"]}},
                "source": ["aws.s3"],
            },
        )
